...
NEW_DATABASE="demo_batch"
NEW_DATABASE_SUB="demo_batch_sub"
NEW_TEST_DATABASE="demo_batch_test"
...
GRANT ALL PRIVILEGES ON $NEW_DATABASE_SUB.* TO '$NEW_USER'@'%';
GRANT ALL PRIVILEGES ON $NEW_TEST_DATABASE.* TO '$NEW_USER'@'%';
FLUSH PRIVILEGES;
CREATE DATABASE IF NOT EXISTS $NEW_DATABASE;
CREATE DATABASE IF NOT EXISTS $NEW_DATABASE_SUB;
